...
function Contact() {
  return (
    <section id="contact" className="bg-[#0f2747] py-16 text-white md:py-20">
      <div className="mx-auto grid max-w-6xl gap-8 px-5 md:grid-cols-[1fr_0.92fr] md:items-center">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.06] p-5">
          <a
            ...
            className="flex items-center gap-3 rounded-2xl bg-[#93c5fd] px-5 py-4 font-black text-[#0f2747] transition hover:bg-white"
          >
            <FaEnvelope />
            reza@domain.com
          </a>
